...
import UploadStopsCSV from "./components/UploadStopsCSV"; // ✅ Importa el nuevo componente

const GTFS_TABLES = [ /* ... tu lista completa ... */
...
function App() {
  ...
  const [availableTables, setAvailableTables] = useState([]);
   ...
   useEffect(() => {
        const fetchTables = async () => { /* ... tu código para cargar tablas ... */
            try {
  ...
  const renderView = () => {
    ...
    switch (activeView) {
      ...
      // ✅ Nuevo caso para el componente de carga CSV
